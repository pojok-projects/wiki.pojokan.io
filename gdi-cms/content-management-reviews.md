...
Dari hasil score diatas Strapi unggul tipis dibandingkan dengan Laravel-admin satu point saja. Dari sisi code simplicity, Laravel-admin lebih unggul karena memiliki teknologi yang umum digunakan di pasaran dan juga memiliki support forms yang banyak sehingga process development jadi cepat dan mudah. Namun dari sisi database support, Laravel-admin masih belum mendukung NoSQL database. 
